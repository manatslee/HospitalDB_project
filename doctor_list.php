...
<body style="width:100%;height:100%;">
    ...
    <div class="row">
                        ...
                        <?php  while($row = mysqli_fetch_assoc($result)) :   ?>
                         <div class="column" >
                                ...
                                <form class="boxx"  action="doctor_info.php" method="POST" >
    ...
    <a href="find_doctor.php"><button class="button button1"style="position:absolute;margin-bottom: 5px; right: 250px">ย้อนกลับ</button></a>
    <div>
    <br><br><br><br>
