<?php
    ...
    if(isset($_POST['appoint'])) {
        ...
        $query1 = "SELECT * FROM department WHERE DName = '$DName'";
        $result1 = mysqli_query($conn,$query1);
        $row1 = mysqli_fetch_assoc($result1);

        $arr1 = str_split($DLocation);
        ...
        $DLocation = mysqli_real_escape_string($conn, $row1['DLocation']);




        $sql ="INSERT INTO appoint(DrID, appDate, Building, PSSN, appTime) 
        VALUES ('$DrID','$date','$DLocation','$SSN','$starttime-$endtime ')";
    ...
    <div style="margin-top: 140px;">
        ...
        <div class="row" style="line-height: 0px;">
            <div class="column" style="width: 45%; text-align: right; ">
                ...
                <p >HN: <?php echo $row['HN'] ?></p>
                <p>เบอร์โทรศัพท์: <?php echo $row['Phone'] ?></p>
                <p>สิทธิการรักษา: <?php echo $row['HealthPlan'] ?></p>
            </div>
            <div class="column" style="width: 45%; margin-left: 50px;">
                 <!-- ดึงข้อมูลจากdatabase -->
                <p>ชื่อ-นามสกุล: <?php echo $row['FName'] ?> <?php echo $row['LName'] ?></p>
                <p>วันที่ออกบัตร: <?php echo date("d/m/Y H:i:s")?></p>
            </div>
        </div>
        <center><table style="width:50%;">
            <tr>
              ...
              <tr>
                ...
                <td ><?php echo $_POST['DName'] ?></td>
                <td>02-99999999</td>
                <td><?php echo $_POST['date'] ?></td>
                <td>เเพทย์ <?php echo $_POST['FName'] ?> <?php echo $_POST['LName'] ?> </td>
        ...
        <center><div class="row" style="width: 50%; text-align: center; margin-left:50%;">
