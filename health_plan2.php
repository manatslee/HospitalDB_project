...
<div class="container py-5">
    <h2 class="h3 font-weight-bold info">โปรแกรมตรวจสุขภาพ</h2>
    <div class="row pt-4">
        <div class="col sm-6 text-center">
                <h5 align ='center'>โปรแกรมตรวจสุขภาพ(Health Check Up Package)</h5>
                <a href="health_plan_1.2.php"><button aglin ='center' type="button" class="btn btn-warning">รายละเอียด</button></a>
                    <br><a href="health_plan_1.2.php"><img src="img/ID1615190181.png" class = "img-fluid w-90 h-50 m-3"></a>
                
        </div>
        <div class="col-sm-6 text-center">
            <h5 align ='center'>วัคซีนป้องกันไข้หวัดใหญ่ 4 สายพันธุ์ 2021 </h5>
            <a href="health_plan_2.2.php"><button aglin ='center' type="button" class="btn btn-warning">รายละเอียด</button></a>
                <br><a href="health_plan_2.2.php"><img src="img/ID1613701778.png" class = "img-fluid w-90 h-50 m-3"></a>
